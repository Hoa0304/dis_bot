...
# CSV FILES
# =========================
POSTS_FILE = "reddit_malaysia_posts.csv"
COMMENTS_FILE = "reddit_malaysia_comments.csv"
...
if __name__ == "__main__":
    print("INVEST MALAYSIA CLUB - Reddit Malaysia Seeder (main_b3)")
    print("Loading data...")
    ...
    for item in all_data:
        ...
        if topic_id:
            ...
            time.sleep(random.uniform(3, 7)) # Reduced delay to speed up but still safe
        else:
            # If we hit an error (like 429), it will be printed by post_topic
            pass
